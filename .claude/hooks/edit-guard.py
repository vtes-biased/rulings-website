#!/usr/bin/env python3
"""PostToolUse(Edit|Write): the two rules a fresh agent forgets. Exit 2 feeds stderr back."""
...
blocking = []
if path.suffix in SOURCE and path.is_file():
...
if "tests" in path.parts:
    # Advisory, not a gate: flag it for the egress reviewer's attention.
    print(
        "Test edit: weakening or deleting a test is an egress rejection unless the "
        "wiki-declared behaviour changed. Say which claim in wiki/ moved."
    )
